...
crook1.style.backgroundImage = "url('crook/Ogen/Ogen1.jpg')";
var crook2 = document.getElementById("crook2");
crook2.style.backgroundImage = "url('crook/Neus/Neus1.jpg')";
var crook3 = document.getElementById("crook3");
crook3.style.backgroundImage = "url('crook/Mond/Mond1.jpg')";
